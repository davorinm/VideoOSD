...
//import AVFoundation
//
//enum VideoRecordingViewError: Error {
//    case deviceNotFound
//    case inputFailed
//    case outputFailed
...
//}
//
//class VideoRecordingView: UIView, AVCaptureFileOutputRecordingDelegate {
...
//    
//    func createSession() -> VideoRecordingViewError? {
...
//    }
//    
//    func startCapturing(to url: URL, completed: ((URL) -> Void)?, error: ((VideoRecordingViewError) -> Void)?) {
