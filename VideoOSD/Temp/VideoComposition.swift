...
//    
//    // https://stackoverflow.com/questions/44256381/add-label-on-video-ios
//
...
//
//        // Video track
//        guard let videoTrack = mixComposition.addMutableTrack(withMediaType: AVMediaType.video, preferredTrackID: kCMPersistentTrackID_Invalid) else {
//            assertionFailure()
//            return
//        }
//
